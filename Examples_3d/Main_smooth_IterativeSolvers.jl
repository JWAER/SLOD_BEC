...
save("./Results/Final_64/J_method_smooth_N_"*string(N)*"_beta_"*string(β)*"_3D_new_basis.jld","UGS",UGS,"E",E,"conv",conv,"t",time()-tid)
ω̃ₕ = 0;
tid = time()
if(dynamics)
	...
	T = 1; Nt = 2^7; max_it = 20; save_it = 1; save_here = "./Results/Final/"; TOL = 10^-8;
